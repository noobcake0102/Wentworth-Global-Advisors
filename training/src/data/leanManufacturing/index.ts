  ...
  lessons: [
    ...
    },
    {
      ...
      content: [
        ...
        { type: 'heading' as const, text: 'Real-World Application', level: 2 as const },
        { type: 'callout' as const, variant: 'example' as const, title: 'Case Study: Danaher Corporation TPS House Deployment', text: 'Danaher Corporation, a diversified industrial manufacturer, acquired Veridian Instruments in 2002 and immediately began installing the Danaher Business System — a direct adaptation of the TPS House. Rather than deploying individual tools ad hoc, the integration team spent the first six months establishing the foundation: standardized work across 12 product lines and a heijunka production-leveling schedule. Only after these were stable did they introduce kanban pull signals and andon systems. Within three years, Veridian\'s on-time delivery rose from 67% to 96%, inventory turns doubled from 4 to 8, and operating margins expanded by 7 percentage points.' },
        { type: 'paragraph' as const, text: 'Danaher\'s disciplined sequencing — foundation before pillars, pillars before roof — mirrors the TPS House architecture exactly. Companies that skip standardized work and production leveling in a rush to implement kanban typically see their pull systems collapse within months because the underlying flow is unstable. The TPS House model provides an implementation roadmap, not just a conceptual diagram.' },
        { type: 'list' as const, items: ['Sequence matters: never install pillars before the foundation is stable', 'Heijunka (production leveling) is frequently skipped yet is essential to make JIT work without chaos', 'Treat the TPS House as an integration guide — each element must connect to the others to deliver results'] },
      ],
    },
  ],
  quiz: [
  ...
  lessons: [
    {
      ...
      content: [
        ...
        { type: 'heading' as const, text: 'Real-World Application', level: 2 as const },
        { type: 'callout' as const, variant: 'example' as const, title: 'Case Study: Caterpillar Redefines Value in Large Equipment Manufacturing', text: 'Caterpillar\'s Aurora, Illinois facility producing hydraulic excavators conducted a customer-value study in 2008 to prepare for a VSM initiative. Field interviews with 200 construction customers revealed that fast parts availability and uptime — not feature richness — defined value. Analysis showed that 38% of engineering change orders added features customers rated as unimportant, consuming design resources and adding 11 days of average lead time. By redefining value strictly through customer eyes, Caterpillar eliminated low-value features from three product lines, cutting design-to-ship lead time by 18 days and reducing per-unit cost by $1,400.' },
        { type: 'paragraph' as const, text: 'Caterpillar\'s experience illustrates why the first Lean principle — specify value from the customer\'s perspective — must precede value stream mapping. Without a clear customer-validated definition of value, VSM teams cannot reliably distinguish value-added from non-value-added steps. What the producer considers valuable (complex features, tight tolerances) may not align with what the customer actually pays for. Getting this wrong causes all subsequent Lean work to optimize the wrong things.' },
        { type: 'list' as const, items: ['Go directly to customers to define value — internal assumptions are frequently wrong', 'Value definitions vary by customer segment; segment your value stream analysis accordingly', 'Value-added activities must pass the test: would the customer pay for this step if they could see it?'] },
      ],
    },
    {
      id: 'lean-m2-l2',
      ...
      content: [
        ...
        { type: 'heading' as const, text: 'Real-World Application', level: 2 as const },
        { type: 'callout' as const, variant: 'example' as const, title: 'Case Study: Intel Semiconductor Fab Transitions from Push to Pull', text: 'Intel\'s Fab 32 in Chandler, Arizona operated on a complex MRP-driven push schedule that generated 21 days of average wafer WIP across 600 process steps. In 2010, Intel piloted a pull-based flow system on two product families, implementing electronic kanban signals and strict WIP limits at each process stage. Flow disruptions that had been buried under inventory piles became immediately visible, prompting targeted equipment reliability improvements. Over 18 months, average cycle time for those families fell from 21 days to 13 days, and on-time die delivery to packaging improved from 79% to 94%.' },
        { type: 'paragraph' as const, text: 'Intel\'s transition demonstrates the inseparable relationship between flow and pull. The team first stabilized equipment uptime (flow) before imposing strict WIP limits (pull), exactly as Lean principle sequencing prescribes. When the pull signals exposed bottlenecks that had been masked by WIP buffers, the team had the process stability needed to address root causes rather than simply adding back inventory as a buffer.' },
        { type: 'list' as const, items: ['Pull systems surface hidden problems — treat that visibility as the benefit, not a drawback', 'Stabilize process flow before tightening pull constraints, or you will create starvation rather than flow', 'Electronic kanban enables pull at high-mix, high-volume operations where physical cards are impractical'] },
      ],
    },
    {
      id: 'lean-m2-l3',
      ...
      content: [
        ...
        { type: 'heading' as const, text: 'Real-World Application', level: 2 as const },
        { type: 'callout' as const, variant: 'example' as const, title: 'Case Study: Wiremold Company\'s 10-Year Pursuit of Perfection', text: 'Wiremold, a Connecticut-based electrical products manufacturer, began its Lean journey in 1991 under CEO Art Byrne. Rather than treating Lean as a project with an end date, Byrne institutionalized the pursuit of perfection through 2,400 kaizen events over 10 years. Each round of improvement revealed the next layer of waste: after achieving 90% on-time delivery, the team discovered scheduling complexity was adding 2 days to lead time; after fixing that, quality escapes to distributors became visible. By 2001, Wiremold had reduced lead times from 4–6 weeks to 1–2 days, inventory turns increased from 3 to 18, and operating income grew from $7.4M to $29.5M annually.' },
        { type: 'paragraph' as const, text: 'Wiremold\'s decade-long journey embodies the virtuous cycle Womack and Jones described: each improvement cycle raises the standard and makes the next layer of waste visible. The pursuit of perfection is not an abstract aspiration — it is the engine of compounding improvement. Organizations that declare "we finished our Lean transformation" stop improving and gradually fall behind competitors who keep iterating.' },
        { type: 'list' as const, items: ['Set a direction toward zero waste and zero defects — measurable targets will cascade naturally from that North Star', 'Each improvement cycle reveals new problems; celebrate this as evidence the system is working', 'Leadership continuity matters enormously: Lean cultures built by one leader can dissolve under a successor who abandons the principles'] },
      ],
    },
  ],
  quiz: [
  ...
  lessons: [
    {
      ...
      content: [
        ...
        { type: 'heading' as const, text: 'Real-World Application', level: 2 as const },
        { type: 'callout' as const, variant: 'example' as const, title: 'Case Study: Parker Hannifin Hydraulics Division 5S Transformation', text: 'Parker Hannifin\'s hydraulics manufacturing plant in Wooster, Ohio launched a 5S initiative across 18 machining cells in 2014. During the Sort phase, teams removed 34 tons of obsolete tooling, fixtures, and raw material — 12% of total floor inventory by weight. Set in Order using shadow boards and floor markings reduced tool-retrieval time from an average of 4.7 minutes to under 30 seconds per occurrence. After institutionalizing Sustain audits with a monthly scoring system tied to department performance reviews, average 5S audit scores rose from 2.1 to 4.3 out of 5 over two years, and unplanned equipment downtime caused by missing or damaged tooling fell by 71%.' },
        { type: 'paragraph' as const, text: 'Parker Hannifin\'s results confirm the often-underappreciated connection between 5S and equipment reliability. Shadow boards and designated locations make missing or damaged tools immediately visible, triggering replacement before the next production run rather than during it. The Sustain scores tied to performance reviews address the most common 5S failure mode — reverting to old habits — by creating organizational accountability for maintaining gains.' },
        { type: 'list' as const, items: ['Red-tag events generate data: track what was removed and why to prevent re-accumulation', 'Shadow boards work because absence is visible — design storage systems around this principle', 'Tie 5S audit scores to department metrics to create the accountability needed for the fifth S'] },
      ],
    },
    {
      id: 'lean-m3-l2',
      ...
      content: [
        ...
        { type: 'heading' as const, text: 'Real-World Application', level: 2 as const },
        { type: 'callout' as const, variant: 'example' as const, title: 'Case Study: Lockheed Martin F-35 Production Visual Management', text: 'Lockheed Martin\'s F-35 assembly facility in Fort Worth, Texas implemented a comprehensive visual management system across its final assembly lines in 2016 to address escalating schedule variance. Hour-by-hour production boards at each work zone tracked planned versus actual aircraft completions at each major assembly stage. Andon lights with four-color coding (green/yellow/red/blue for maintenance) were installed at 240 stations. Within 12 months of full deployment, supervisor response time to line stoppages dropped from an average of 23 minutes to under 4 minutes, and schedule adherence at final assembly improved from 71% to 89%, contributing to a 14% reduction in cost per aircraft.' },
        { type: 'paragraph' as const, text: 'Lockheed\'s deployment illustrates that visual management is not limited to high-volume repetitive manufacturing — it scales to complex, low-volume aerospace assembly where each unit takes months to build. The principle is identical: make the current state of the process immediately visible so that deviations from plan are detected and responded to quickly rather than discovered days later in a review meeting. The faster the response, the lower the cost of the deviation.' },
        { type: 'list' as const, items: ['Visual management compresses the gap between problem occurrence and problem response', 'Hour-by-hour boards work best when supervisors are empowered to act on the data within the shift — not just report it', 'Design visual controls for the worst-case user: someone unfamiliar with the process should still be able to read the system'] },
      ],
    },
    {
      id: 'lean-m3-l3',
      ...
      content: [
        ...
        { type: 'heading' as const, text: 'Real-World Application', level: 2 as const },
        { type: 'callout' as const, variant: 'example' as const, title: 'Case Study: Medtronic Surgical Instruments Standardized Work Deployment', text: 'Medtronic\'s surgical instrument manufacturing facility in Jacksonville, Florida faced high process variability across its 240-person assembly workforce in 2012, with cycle times for the same operation varying by up to 140% between operators. Industrial engineers partnered with assembly technicians to develop standardized work documents for 87 operations, capturing the best-known method through video analysis and time studies. Standard Work Combination Sheets were posted at each station and updated whenever a kaizen yielded a better method. Over 24 months, cycle time variability dropped from 140% to under 15%, first-pass yield improved from 91% to 98.3%, and new-employee training time decreased by 35% because learnable standards replaced tribal knowledge.' },
        { type: 'paragraph' as const, text: 'Medtronic\'s initiative demonstrates the two-sided value of standardized work: it both reduces variability in the current state and creates the baseline from which future kaizen improvements are measured. Without the initial standards, the team could not have proven that new methods were genuinely better — every result would have been obscured by baseline variation. The 35% reduction in training time reflects an often-overlooked dividend of standardization: knowledge becomes institutional rather than individual.' },
        { type: 'list' as const, items: ['Develop standards with the workers who do the job — they possess knowledge that time studies alone cannot capture', 'Post standardized work visually at the point of use, not in a binder in the supervisor\'s office', 'Track standard adherence rate separately from output rate — a team hitting targets by deviating from standards is hiding future problems'] },
      ],
    },
  ],
  quiz: [
  ...
  lessons: [
    {
      ...
      content: [
        ...
        { type: 'heading' as const, text: 'Real-World Application', level: 2 as const },
        { type: 'callout' as const, variant: 'example' as const, title: 'Case Study: Harley-Davidson JIT Transformation at Kansas City', text: 'Harley-Davidson\'s Kansas City motorcycle assembly plant, opened in 1998, was designed from the ground up on JIT principles after the company\'s near-bankruptcy in the 1980s. Suppliers delivering frame components, powertrain parts, and paint systems were required to deliver in windows as narrow as two hours, with maximum lot sizes of 30 units. The plant carried less than eight hours of raw material on the floor at any time. When a 2003 tornado disrupted supplier routes, the factory exhausted its paint inventory in six hours — exposing a JIT vulnerability. In response, Harley strategically repositioned two days of paint buffer for weather-disruption scenarios while maintaining two-hour windows for all other components, preserving 96% of the JIT efficiency gains.' },
        { type: 'paragraph' as const, text: 'Harley-Davidson\'s experience captures both the power and the calibrated risk of JIT. The eight-hour raw material window cut inventory carrying costs by $41M annually compared to the company\'s pre-1990s practices. The tornado episode validated the JIT risk assessment literature: supply chain disruptions hit hardest at the components with the fewest alternative suppliers and longest recovery lead times. The nuanced response — strategic buffering for specific vulnerabilities rather than abandoning JIT — reflects mature JIT thinking.' },
        { type: 'list' as const, items: ['Map your supply chain\'s single points of failure before tightening JIT windows — not after a disruption forces the issue', 'JIT supplier relationships require investment in supplier capability, not just contractual delivery requirements', 'Small strategic buffers for genuinely disruption-prone inputs are compatible with JIT philosophy'] },
      ],
    },
    {
      id: 'lean-m4-l2',
      ...
      content: [
        ...
        { type: 'heading' as const, text: 'Real-World Application', level: 2 as const },
        { type: 'callout' as const, variant: 'example' as const, title: 'Case Study: Zara Fast Fashion Kanban-Inspired Replenishment', text: 'Inditex\'s Zara brand operates one of the most sophisticated pull replenishment systems outside of automotive manufacturing. Each of Zara\'s 2,200 stores worldwide transmits daily sell-through data that functions as a kanban signal to the company\'s distribution centers in Spain. Replenishment quantities are calculated by item, size, and store, and new merchandise arrives twice weekly at each store. No stock is produced speculatively beyond a small display floor quantity. This system enables Zara to go from design approval to store shelf in 15 days and to retire items after two weeks when sell-through signals weaken — compared to 6-month cycles for traditional fashion retailers — resulting in a markdown rate of just 15% vs. the industry average of 50%.' },
        { type: 'paragraph' as const, text: 'Zara\'s model translates the kanban principle — downstream consumption authorizes upstream replenishment — from a factory floor to a global retail network. The daily sell-through data is the kanban card; the store shelf is the supermarket buffer; the distribution center is the upstream production process. The dramatic difference in markdown rates versus traditional retailers is a direct measure of the cost of push-based forecasting: 35% of inventory becomes waste in push systems versus 15% in Zara\'s pull system.' },
        { type: 'list' as const, items: ['Kanban logic applies anywhere a buffer connects supply to demand — retail, healthcare, and software as well as manufacturing', 'Reducing kanban card count (or replenishment quantity) over time forces process improvement — the same discipline applies in any industry', 'Consumption signals must be timely and accurate for pull systems to work; data latency is the equivalent of a missing kanban card'] },
      ],
    },
    {
      id: 'lean-m4-l3',
      ...
      content: [
        ...
        { type: 'heading' as const, text: 'Real-World Application', level: 2 as const },
        { type: 'callout' as const, variant: 'example' as const, title: 'Case Study: Airbus A320 Final Assembly WIP Limits and Takt Management', text: 'Airbus\'s Hamburg final assembly facility introduced takt-based production for the A320 family in 2006, replacing a stationary-aircraft model with a moving-line approach. Engineers calculated a takt time of 4 working days per aircraft position based on an annual delivery target of 36 aircraft per month across the facility\'s 9 assembly stations. WIP was capped at exactly 9 aircraft — one per station. When a late supplier delivery threatened to exceed WIP limits on Station 40 (wing join), rather than accepting the part late and pushing WIP into Station 50, the line was held and a formal supplier escalation triggered. This discipline reduced late deliveries caused by absorbed WIP overflows by 67% in the first year.' },
        { type: 'paragraph' as const, text: 'Airbus\'s strict enforcement of both takt time and WIP limits demonstrates how these two concepts reinforce each other in practice. Takt time set the production pace and defined how many positions were needed; WIP limits made violations of that pace immediately visible rather than absorbed into schedule buffers. The holding of the line at Station 40 — a costly decision in absolute terms — prevented far costlier downstream rework and schedule slippage by surfacing the supplier issue immediately.' },
        { type: 'list' as const, items: ['Takt time is a system design parameter — calculate it before designing workstation content, not after', 'WIP limits are only effective if the system is willing to stop when the limit is hit — otherwise they are just targets', 'Little\'s Law provides the mathematical foundation for setting WIP limits: decide your lead time target, then calculate the maximum WIP you can carry'] },
      ],
    },
  ],
  quiz: [
  ...
  lessons: [
    {
      ...
      content: [
        ...
        { type: 'heading' as const, text: 'Real-World Application', level: 2 as const },
        { type: 'callout' as const, variant: 'example' as const, title: 'Case Study: Frito-Lay TPM Deployment at Modesto Plant', text: 'Frito-Lay\'s Modesto, California snack food facility launched a full TPM deployment in 2009 after its OEE on potato chip frying lines averaged 54% — well below the food industry benchmark of 75%. Component analysis revealed Availability was the primary loss driver at 71%, while Performance was 82% and Quality 93%. Root cause analysis identified 14 recurring failure modes consuming 63% of all downtime. Focused Improvement teams eliminated 11 of the 14 failure modes through equipment redesign and predictive maintenance schedules. After 30 months, overall OEE reached 81%, product output increased by 28% on the same equipment, and maintenance labor costs per unit fell by 34%.' },
        { type: 'paragraph' as const, text: 'Frito-Lay\'s OEE disaggregation directed improvement resources precisely where they were needed. Had the team treated OEE as a single number, they might have pursued quality improvement programs — but the 93% Quality component was already strong. The Availability weakness pointed unambiguously to TPM and maintenance strategy. This diagnostic precision is the core value of measuring OEE in its component parts rather than as a summary score.' },
        { type: 'list' as const, items: ['Always disaggregate OEE into Availability, Performance, and Quality before planning improvement activities', 'Track OEE by machine and shift — aggregate plant OEE hides the variation that drives improvement decisions', 'A world-class OEE target of 85% means all three components must exceed 95% — any one weak component drags the product below target'] },
      ],
    },
    {
      id: 'lean-m5-l2',
      ...
      content: [
        ...
        { type: 'heading' as const, text: 'Real-World Application', level: 2 as const },
        { type: 'callout' as const, variant: 'example' as const, title: 'Case Study: Procter & Gamble Lima Plant Autonomous Maintenance', text: 'P&G\'s Lima, Ohio laundry detergent manufacturing facility piloted Autonomous Maintenance on its high-speed filling lines in 2011. During Step 1 initial cleaning events, operators discovered 89 abnormalities that maintenance staff had not flagged in routine rounds — including a seal degradation pattern that, left unaddressed, would have caused a scheduled production line to fail within weeks. After completing Steps 1–3 across all 6 filling lines, unplanned downtime fell from 8.4% to 2.1% of available time within 14 months. Maintenance call frequency dropped 58%, freeing maintenance technicians to focus on planned maintenance and reliability engineering rather than emergency response.' },
        { type: 'paragraph' as const, text: 'P&G\'s Lima results validate the core premise of Autonomous Maintenance: operators who work with equipment daily can detect subtle changes that maintenance technicians — who visit on scheduled rounds — routinely miss. The 89 abnormalities found during initial cleaning represent years of accumulated deterioration that became visible only when operators were given the time, tools, and authority to look carefully. The shift in maintenance technician time from reactive to proactive work is a structural benefit that compounds over subsequent years.' },
        { type: 'list' as const, items: ['Budget dedicated time for Step 1 cleaning events — compressing them into break time signals that AM is not a real priority', 'Create a simple tagging and tracking system so abnormalities found during cleaning are resolved, not just documented', 'Measure maintenance call frequency separately from OEE — it is a leading indicator of AM effectiveness before OEE improvements become visible'] },
      ],
    },
    {
      id: 'lean-m5-l3',
      ...
      content: [
        ...
        { type: 'heading' as const, text: 'Real-World Application', level: 2 as const },
        { type: 'callout' as const, variant: 'example' as const, title: 'Case Study: Johnson & Johnson Medical Devices Poka-Yoke and Jidoka Integration', text: 'Johnson & Johnson\'s DePuy Synthes orthopedic implant facility in Warsaw, Indiana faced a critical quality challenge in 2013: incorrect implant sizing contributed to a 0.8% surgical revision rate — unacceptably high for life-critical medical devices. Engineers implemented a two-layer defense: prevention poka-yokes (physical fixtures that accepted only the correct size component during machining, making wrong-size production physically impossible) and jidoka sensors (in-process dimensional gauges that stopped machining automatically if any feature was outside tolerance). Over 18 months, the surgical revision rate attributable to manufacturing dimensional errors fell from 0.8% to 0.03%, and internal inspection cost dropped by $2.1M annually by shifting from batch end-of-line inspection to in-process detection.' },
        { type: 'paragraph' as const, text: 'J&J\'s layered approach demonstrates the complementary roles of poka-yoke and jidoka. Prevention poka-yokes eliminate the most common error modes; jidoka sensors catch the rare cases that prevention mechanisms miss. Together they achieve detection and response at the source — before the defective part reaches the next operation, let alone the customer. In medical device manufacturing, where downstream defect costs include patient harm and massive recall expenses, the ROI on built-in quality versus end-of-line inspection is unambiguous.' },
        { type: 'list' as const, items: ['Design prevention poka-yokes first — they eliminate errors entirely rather than merely detecting them', 'In-process detection at the point of creation is always cheaper than end-of-line inspection or field failure', 'Never penalize operators for triggering jidoka stops — the stop is the system working correctly, not a failure'] },
      ],
    },
  ],
  quiz: [
  ...
  lessons: [
    {
      ...
      content: [
        ...
        { type: 'heading' as const, text: 'Real-World Application', level: 2 as const },
        { type: 'callout' as const, variant: 'example' as const, title: 'Case Study: Autoliv Airbag Manufacturing Kaizen Culture', text: 'Autoliv, the world\'s largest automotive safety supplier, embedded kaizen as a core operational discipline across its Utah airbag manufacturing facility starting in 2005. The plant established a goal of 12 implemented suggestions per employee per year — not ideas submitted, but changes actually made. Team leaders were allocated two hours per week to support worker-initiated improvements. By 2010, the facility averaged 14.2 implemented suggestions per employee annually, generating over 8,000 documented improvements per year. Cumulative effects included a 44% reduction in workplace injury rates, a 31% improvement in material yield, and a 19% reduction in manufacturing cost per unit over the five-year period — translating to $23M in annual cost savings.' },
        { type: 'paragraph' as const, text: 'Autoliv\'s metrics illustrate why daily kaizen at scale outperforms periodic large-scale events. The 8,000 annual improvements at the Utah facility represent continuous, distributed problem-solving that no project team — however talented — could replicate in a series of kaizen blitzes. The two-hour weekly allocation for team leaders is the organizational investment that makes this possible: without dedicated time, kaizen reverts to a suggestion box that nobody reads.' },
        { type: 'list' as const, items: ['Measure implemented improvements, not suggestions submitted — the implementation rate reveals whether the system actually empowers workers', 'Allocate explicit time for kaizen in team leader schedules — improvement does not happen in the gaps between production pressures', 'Celebrate small improvements publicly; a 30-second time savings recognized promptly generates more subsequent improvements than a large project reward given months later'] },
      ],
    },
    {
      id: 'lean-m6-l2',
      ...
      content: [
        ...
        { type: 'heading' as const, text: 'Real-World Application', level: 2 as const },
        { type: 'callout' as const, variant: 'example' as const, title: 'Case Study: Cleveland Clinic A3 Deployment in Sterile Processing', text: 'Cleveland Clinic\'s sterile processing department faced a recurring surgical instrument shortage problem in 2015 that was delaying operating room starts by an average of 23 minutes per affected case — costing approximately $180,000 per month in OR idle time and surgeon fees. A cross-departmental team developed an A3 that mapped the current-state instrument reprocessing flow, revealing that 78% of delays originated from a single step: the "case cart build" that assembled instruments for each OR case was started too late because the build schedule was triggered by paper requisitions rather than electronic OR scheduling data. The countermeasure — integrating the OR scheduling system directly with case cart build triggers — reduced average OR delay from 23 minutes to under 4 minutes within 90 days, recovering $155,000 per month.' },
        { type: 'paragraph' as const, text: 'Cleveland Clinic\'s A3 process succeeded where previous attempts at the same problem had failed because the structured format forced the team to confirm root causes with data before selecting countermeasures. Earlier informal improvement efforts had focused on staffing levels and reprocessing speed — symptoms rather than root causes. The A3\'s "Current Condition" discipline of mapping the actual flow revealed that the real cause was a scheduling system disconnection that no one in the department had visibility into.' },
        { type: 'list' as const, items: ['Resist moving to countermeasures until root cause analysis is complete and validated with data — premature solutions are the most common A3 failure mode', 'A3 thinking scales from a factory floor to any service or administrative process where a problem has a definable current state and target condition', 'The one-page constraint is a feature, not a limitation — it forces the clarity needed to build consensus across functions'] },
      ],
    },
    {
      id: 'lean-m6-l3',
      ...
      content: [
        ...
        { type: 'heading' as const, text: 'Real-World Application', level: 2 as const },
        { type: 'callout' as const, variant: 'example' as const, title: 'Case Study: Alcoa\'s CEO-Led Safety and Lean Culture Transformation', text: 'When Paul O\'Neill became CEO of Alcoa in 1987, the aluminum manufacturer was struggling with inconsistent quality and high turnover. O\'Neill made safety the singular measure of leadership behavior — not as a program, but as a test of whether leaders would go to the gemba, listen to workers, and fix systemic problems rather than assign blame. Every injury required the relevant plant manager to notify O\'Neill personally within 24 hours with a root cause analysis and corrective plan. This leadership accountability model spread to quality and productivity. By 1999 when O\'Neill retired, Alcoa\'s worker injury rate had fallen from 1.86 incidents per 100 workers to 0.2 — one of the lowest in the industry — while net income grew from $200M to $1.5B and productivity per employee increased by 47%.' },
        { type: 'paragraph' as const, text: 'O\'Neill\'s Alcoa transformation is a masterclass in how leadership behavior — not tools — determines whether Lean culture takes root. By making safety the visible test of whether leaders walked the gemba and solved systemic problems, O\'Neill created behavioral norms that transferred directly to quality and productivity. The 24-hour notification requirement for injuries was equivalent to a mandatory gemba walk and A3 process: leaders had to see the actual condition, understand the root cause, and commit to a countermeasure. Culture followed from behavior, not from training programs.' },
        { type: 'list' as const, items: ['Choose one visible, undeniable metric that tests whether leadership behaviors are changing — it will pull culture behind it', 'Leaders who manage from reports and offices cannot build Lean culture regardless of how many tools they deploy', 'Sustaining Lean requires updating appraisal and accountability systems so that the organizational rewards reinforce Lean behaviors'] },
      ],
    },
  ],
  quiz: [
